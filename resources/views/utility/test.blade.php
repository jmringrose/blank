...
@section('content')
    ...
    <div class="container max-w-5xl mx-auto text-base">
        ...
        <!--regular tailwind -->
        <div class="align-left bg-info-600 rounded-lg shadow-lg p-2 mb-6 border border-base-200 w-[400px]">Regular Tailwind</div>
        <div class="flex">
            <div class="p-4 border bg-info text-base-300 border-gray-400 rounded-lg mr-4">Div 1</div>
            <div class="p-4 border border-gray-400 rounded-lg mr-4">Div 2</div>
            <div class="p-4 border border-gray-400 rounded-lg mr-4">Div 3</div>
            <div class="p-4 border border-gray-400 rounded-lg mr-4">Div 4</div>
        </div>
        <div class="mt-4 align-left bg-info-600 rounded-lg shadow-lg p-2 mb-6 border border-base-200 w-[400px]">Daisy UI</div>
        <!-- buttons -->
        <div class="p-4">
